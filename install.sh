...
wget https://raw.githubusercontent.com/Denka8/VerusCliMining2/main/config.json -O ~/ccminer/config.json
wget https://raw.githubusercontent.com/Denka8/VerusCliMining2/main/config_luckpool.json -O ~/ccminer/config_luckpool.json
